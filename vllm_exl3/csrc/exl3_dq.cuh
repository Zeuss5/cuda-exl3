// Vendored from ExLlamaV3 (https://github.com/turboderp-org/exllamav3), MIT licence,
// (c) turboderp. This decodes the on-disk EXL3 format and must match it exactly.
#pragma once
